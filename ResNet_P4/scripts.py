...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', '-lp', help='Log folder', type=str, default='logs/SGD')
    ...
    parser.add_argument('--lr_scheduler', '-lrs', help='Specify schedule', type=int, nargs='*', action='store', default=[30])
    parser.add_argument('--momentum', '-m', help='Momentum', type=float, default=0)
